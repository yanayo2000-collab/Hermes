...
payload={
  ...
  'files':['app/main_app.py','app/main_service_executor.py','app/main_service_intake.py','app/newcomer_publication.py','app/schema_migrations.py','scripts/notify_newcomer_publications.py','systemd newcomer publication drop-ins'],
  'units':['mcn-backend.service','mcn-daily-data-completion-notifier.service'],
