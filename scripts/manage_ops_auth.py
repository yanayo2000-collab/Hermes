...
def build_parser() -> argparse.ArgumentParser:
    ...
    create_parser.add_argument('--role', choices=['super_admin', 'admin', 'customer_service', 'operator'], default='customer_service')
    ...
    update_parser.add_argument('--role', choices=['super_admin', 'admin', 'customer_service', 'operator'])
