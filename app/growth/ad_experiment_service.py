...
EXPERIMENT_TRANSITIONS = {
    ...
    "ADJUSTING": {"META_REVIEW_PENDING", "RUNNING", "EVALUATING_ADJUSTMENT", "CREATION_PARTIAL_FAILURE", "DATA_INCOMPLETE"},
    "EVALUATING_ADJUSTMENT": {"CREATIVE_REJECTED", "META_REVIEW_PENDING", "RUNNING", "EFFECTIVE", "INEFFECTIVE", "INCONCLUSIVE", "DATA_INCOMPLETE", "MIXED_CHANGE"},
